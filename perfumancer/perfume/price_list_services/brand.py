...
brand_synonyms = {
    ...
    "EX NIHILO": ["ex nihilo"],
    "FENDI": ["fendi"],
    "FERRAGAMO": ["SALVATORE FERRAGAMO", "FERRAGAMO SALVATORE", "ferragamo", "ferragamo salvatore", "s. ferragamo", "salvatore ferragamo", "salvatore", "s.ferragamo"],
