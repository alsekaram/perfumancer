...
class FrenchNameNormalizer:
    def __init__(self):
        ...
        self.exceptions_for_dangling = [
            'terre de', 'homme de', 'femme de'
        ]
    ...
    def _compile_patterns(self):
        ...
        self.dangling_pattern = re.compile(
            r'\b(' + '|'.join(self.dangling_prepositions) + r')\s*$',
            re.IGNORECASE
        )
    ...
    def normalize(self, text: str) -> str:
        ...
        text = re.sub(r'(\w)d([aeiouy])', r'\1d\'\2', text)  # Замена "darpege" на "d'arpege"
