...
class PriceList(models.Model):
    product = models.ForeignKey(ProductBase, on_delete=models.CASCADE, related_name='price_lists', verbose_name="Товар",
    ...
    price = models.DecimalField(max_digits=8, decimal_places=2, verbose_name="Цена", help_text="Цена товара")
